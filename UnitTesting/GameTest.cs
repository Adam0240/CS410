...
public class GameTest
{
    ...
    //Tests to ensure the protagonist steps are updated correctly when a valid command is called, 
    //but not when it isn't
    //as of writing this method it fails due to a bug in ProcessCommand
    [Fact]
